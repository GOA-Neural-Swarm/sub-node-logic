...
const fs = require('fs'); //  ကနှခွဲ့သညကွို ထပပြေါငြး
const { execSync } = require('child_process'); //  ကနှခွဲ့သညကွို ထပပြေါငြး
...
const scienceDomains = [
  ...
  //  ECONOMICS, SOCIETY & PHILOSOPHY (401-500)
